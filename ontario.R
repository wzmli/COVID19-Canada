...
ggsave(gg_pos, filename="ggpos.png", width = 4, height=6) 
...
ggsave(gg_ontario_backlog, filename="ggbacklog.png", width = 4, height=6) 
...
ggsave(gg_diffs, filename="ggdiffs.png", width = 4, height=6) 
